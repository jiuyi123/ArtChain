        ...
        <el-scrollbar height="480px" style="border: #3E3E3E">
          <el-table :data="tableData"  stripe border style="width:100%;" >
            <el-table-column
                ...
                width="100%"
                sortable/>
<!--            <el-table-column   align="center" label="艺术品" width="180%">-->
<!--              &lt;!&ndash;            prop="nftLoc"&ndash;&gt;-->
<!--              &lt;!&ndash;            <el-avatar  shape="square" :size="30" :src="url"/>&ndash;&gt;-->
